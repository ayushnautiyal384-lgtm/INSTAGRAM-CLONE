...
const stories = [
  {
    id: 1,
    name: "Your story",
    image: "https://pbs.twimg.com/media/HIQ1iqkaYAEKETs?format=jpg&name=medium",
  },
  {
    id: 2,
    name: "Sabrina.C",
    image: "https://pbs.twimg.com/media/HIEDfOAWMAAduZo?format=jpg&name=large",
  },
  {
    id: 3,
    name: "Ankita.y",
...
const Stories = () => {
  return (
    <div className="w-full bg-black overflow-x-auto py-4">
      <div className="flex justify-center gap-4 px-3 min-w-max">
        {stories.map((story) => (
          <div key={story.id} className="flex flex-col items-center shrink-0">
            ...
            <p className="text-white text-xs mt-2">{story.name}</p>
          </div>
        ))}
      </div>
    </div>
